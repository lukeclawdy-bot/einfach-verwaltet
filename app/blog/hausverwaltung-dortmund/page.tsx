          ...
          <div className="prose prose-lg max-w-none text-gray-700 leading-relaxed space-y-6">
            ...
            <div className="not-prose bg-teal/5 border border-teal/20 rounded-xl p-4 my-6 flex items-center gap-4">
              ...
              <div className="flex-1">
                ...
                <Link href="/hausverwaltung-dortmund" className="text-sm font-semibold text-navy hover:text-teal transition-colors">
                  Hausverwaltung Dortmund — Preise, Leistungen & FAQ →
                </Link>
              </div>
            </div>

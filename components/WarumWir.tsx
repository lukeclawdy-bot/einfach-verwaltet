    ...
    <section className="py-20 lg:py-32 bg-warm-white">
      <div className="max-w-[1100px] mx-auto px-6">
        ...
        <div className="text-center mb-10">
          <h3 className="text-2xl font-bold text-navy font-serif">Was Eigentümer sagen</h3>
          <p className="text-text-light mt-2 text-sm">[Vorschau: Erfahrungsberichte unserer ersten Kunden]</p>
        </div>

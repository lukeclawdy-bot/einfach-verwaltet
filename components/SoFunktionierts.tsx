...
const steps = [
  { num: "01", time: "30 Min", title: "Kostenloses Erstgespräch", desc: "Sie schildern Ihre Situation — wir hören zu. Kein Verkaufsgespräch, keine Überrumpelung. 30 Minuten, telefonisch oder in Hamburg." },
  { num: "02", time: "48 Std", title: "Individuelles Angebot", desc: "Innerhalb von 48 Stunden erhalten Sie ein schriftliches Angebot — mit klaren Preisen, konkreten Leistungen und ohne versteckte Klauseln." },
  { num: "03", time: "4–6 Wochen", title: "Reibungsloser Wechsel", desc: "Wir koordinieren die Übergabe mit Ihrer bisherigen Verwaltung. Kein Aufwand für Sie — wir kümmern uns um die Unterlagen und Schlüssel." },
  { num: "04", time: "Dauerhaft", title: "Volle Kontrolle, null Stress", desc: "Ab dem ersten Tag: Ihr Eigentümerportal ist live. Alle Abrechnungen, Belege, Wartungshistorien — jederzeit einsehbar. Wir melden uns zuerst." },
];
